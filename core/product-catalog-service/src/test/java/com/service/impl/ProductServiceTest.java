...
import com.mapper.ObjectMapperConfiguration;
...
public class ProductServiceTest {
    ...
    @InjectMocks
    private ObjectMapperConfiguration mapperConfig;
    ...
    public void testGetProducts() {
        ...
        List<ProductModel> productVos = service.getProducts();
    ...
    public void testGetProductsByNameAndType() {
        ...
        List<ProductModel> productVos = service.getProductsByNameAndType("Intel Core i5-7500 Processor", "processor");
        Assert.assertTrue(productVos.size() == products.size());
    }
    ...
    public void testGetProductsByType() {
        ...
        List<ProductModel> productVos = service.getProductsByType("ram");
        Assert.assertTrue(productVos.size() == products.size());
    }
